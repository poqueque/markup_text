...
class MarkupParser {
  ...
  static Map<String, Color> colors = {
    ...
    "primaries": Colors.primaries.first,
    "accents": Colors.accents.first,
  };

  // cat ~/development/flutter/packages/flutter/lib/src/material/icons.dart | grep "static const" | cut -f6 -d" " | awk '{print "\"" $1 "\": Icons." $1 ","}'
  static Map<String, IconData> iconData = {
    "ten_k": Icons.ten_k,
